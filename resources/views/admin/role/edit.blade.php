    ...
    <div id="content" class="container-fluid">
        <div class="card">
            <div class="card-header font-weight-bold d-flex justify-content-between align-items-center">
                <h5 class="m-0 mt-2 mb-2 p-0 fw-bold"><i class="fa-solid fa-pen-to-square"></i> Chỉnh sửa chi tiết vai trò
                </h5>
            </div>
            <div class="card-body">
                                ...
                                @foreach ($modulePermission as $permission)
                                    <div class="col-md-3 my-2">
                                        ...
                                        {{ Form::checkbox(
                                            ...
                                            ['id' => $permission->slug, 'class' => 'permission btn-check', 'autocomplete' => 'off'],
                                        ) }}
                ...
                @endforeach
                <input type="submit" name="btn-add" class="btn btn-warning mt-3 form-control" value="Cập nhật">
                {{-- </form> --}}
            </div>
        </div>
    </div>
